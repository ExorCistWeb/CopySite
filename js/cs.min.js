    ...
    t.ACTION_CHAT_HISTORY = "chat.history", t.ACTION_MESSAGE_CREATE = "message.create", t.ACTION_AUTO_MESSAGE_CREATE = "message.auto.create", t.EVENT_MESSAGE_CREATED = "message.created", t.EVENT_MESSAGE_UPDATED = "message.updated", t.EVENT_MESSAGE_DELETED = "message.deleted", t.EVENT_MESSAGE_STATUS_UPDATED = "message.status.updated"; var a = function() {
        function e() { var e;
            ...
            this.callbacks[i.id] = function(e) { if (this.eventSubscribers[t.ACTION_CHAT_HISTORY]) { var n = []; if (Array.isArray(e.result))
                    ...
                    case /^$/.test(n.type):
                        return r("Ошибка: неподдерживаемый формат файла.");
                ...
                s.ajax("https://" + this.connectionParams.apiHost + "/" + this.connectionParams.omniAccountId + "/" + this.connectionParams.comagicVisitorId + "/resource", { method: "POST", data: a, headers: {}, complete: function(n) { n = JSON.parse(n.response), c.socket.send(c.makeOmniRequest(e, { reply_id: null, text: t, context: o || {}, resource_id: n.id })) }.bind(c), error: function(e) { i.util.log("[Omni client]", "File upload error", e.responseText), r && r("Ошибка " + e.status + ": не удалось отправить файл.") } }) } else this.socket.send(this.makeOmniRequest(e, { reply_id: null, text: t, context: o || {} })) }, e.prototype.handleWSResponseMessage = function(e) { e.error || e.result && e.id in this.callbacks && (this.callbacks[e.id](e), delete this.callbacks[e.id]) }, e.prototype.handleWSEventMessage = function(e) { switch (e.method) {
